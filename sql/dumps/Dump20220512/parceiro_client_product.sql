...
CREATE TABLE `client_product` (
  ...
  `USU_ARIO` int(11) DEFAULT NULL,
  `VEN_DA` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID_COMPRA`),
  KEY `ID_USER` (`USU_ARIO`),
  KEY `ID_VENDA` (`VEN_DA`)
...
INSERT INTO `client_product` VALUES (1,9,3),(2,1,5),(3,3,2),(4,4,7),(5,2,5),(6,4,9),(7,7,5),(8,5,3),(9,9,2);
